 ...
 ******************************************************
 ******************************************************
 * Clase Java para implementar una aplicación basada
 * en Java Swing que permite conectarse a una aplicación
 * basada en la estructura de un servidor de sockets
 * por medio de la resolución de dicho servidor
 * a través de una dirección IP y un puerto
 * de resolución del servicio.
 ******************************************************
 ******************************************************
 ******************************************************
 * */
